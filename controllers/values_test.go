...
var _ = Describe("Helm Values", func() {
	Describe("mergeMaps", func() {
		It("should merge two maps", func() {
			...
			map2 := map[string]interface{}{"key2": "newvalue2", "key3": "value3"}
		...
		It("should handle nested maps", func() {
			map1 := map[string]interface{}{
				"key1": "value1",
				"key2": map[string]interface{}{"nestedKey1": "nestedValue1"},
			}
			map2 := map[string]interface{}{
				"key2": map[string]interface{}{"nestedKey2": "nestedValue2"},
				"key3": "value3",
			}
			...
			nestedMap := merged["key2"].(map[string]interface{})
	...
	Describe("mergeHelmValues", func() {
		It("should merge Helm flat values", func() {
			filePaths := []string{
				createTempValueFile("values1.yaml", map[string]interface{}{"key1": "value1"}),
				createTempValueFile("values2.yaml", map[string]interface{}{"key2": "value2"}),
				createTempValueFile("values3.yaml", map[string]interface{}{"key3": "value3"}),
			}
		...
		It("should merge Helm nested values", func() {
			filePaths := []string{
				createTempValueFile("values4.yaml", map[string]interface{}{"key1": map[string]interface{}{"value1": "nested1"}}),
				createTempValueFile("values5.yaml", map[string]interface{}{"key2": "value2", "key3": "value3"}),
				createTempValueFile("values6.yaml", map[string]interface{}{"key4": "value4"}),
				createTempValueFile("values7.yaml", map[string]interface{}{"key2": "overridden"}),
			}
...
func createTempValueFile(name string, content interface{}) string {
