...
require (
	...
	github.com/openshift/client-go v0.0.0-20220511142756-cee0adb6b260
	github.com/operator-framework/api v0.14.1-0.20220413143725-33310d6154f3
	github.com/operator-framework/operator-lifecycle-manager v0.21.0
...
replace (
	...
	// k8s.io/kube-openapi => 1522a18e5877947f6243e65d4e8d4b8dd22ae23d v0.0.0-20220328201542-3ee0da9b0b42
